...
$(document).ready(function() {
    ...
    // Twitter feed
    $.getJSON('https://api.twitter.com/1/statuses/user_timeline/envato.json?callback=twitterCallback2&count=4', function(data){
...
JQTWEET = {    
    ...
    user: 'envato', // Your Twitter username
    numTweets: 2, // Number of tweets to be displayed
    appendTo: '#twitter',
